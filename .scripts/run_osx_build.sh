...
validate_recipe_outputs "soapysdr-module-plutosdr-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="soapysdr-module-plutosdr-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi